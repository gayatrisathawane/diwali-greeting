...
const Home = () => {
   ...
   return (
    <div>
        ...
        <p className='url'>{`${process.env.PORT}/?to=${to}&from=${from}&g=${greetingNumber}&t=${theme}`}</p>
          ...
          <div className='input-field-container'>
           ...
           <input type="text" value={from}
            ...
            <select  onClick={(e)=>{
                ...
                <option value="1">greet 1</option>
                <option value="2">greet 2</option>
                <option value="3">greet 3</option>
                <option value="4">greet 4</option>
            </select>
